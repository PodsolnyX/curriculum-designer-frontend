...
let versionDefaultOptions: Omit<
...
export function setVersionDefaultOptions(
  options: typeof versionDefaultOptions,
) {
...
export function versionQueryKey(...params: any[]): QueryKey {
  return trimArrayEnd(['VersionClient', 'version']);
}
export function __version(
  context: QueryFunctionContext,
  axiosConfig?: AxiosRequestConfig | undefined,
) {
  return Client.version(axiosConfig);
}
 ...
 */
export function useVersionQuery<TSelectData = string, TError = unknown>(
...
export function useVersionQuery<TSelectData = string, TError = unknown>(
  ...
  return useQuery<string, TError, TSelectData>({
    queryFn: axiosConfig
      ? (context) => __version(context, axiosConfig)
      : __version,
    queryKey: versionQueryKey(),
    ...(versionDefaultOptions as unknown as Omit<
...
export function setVersionData(
  ...
  queryClient.setQueryData(versionQueryKey(), updater);
}
 ...
 * @return A string representing the version.
 */
export function setVersionDataByQueryId(
  queryClient: QueryClient,
  queryKey: QueryKey,
  updater: (data: string | undefined) => string,
) {
