...
import {
    concatIds,
    cutSemesterIdFromId, getIdFromPrefix, getSemesterIdFromPrefix,
    setPrefixToId
...
const Sidebar = () => {
    ...
    return (
        <div style={{height: "calc(100vh - 64px)"}}
             className={"overflow-y-auto bg-white/[0.8] max-w-[330px] w-full backdrop-blur p-5 min-h-full border-l border-l-stone-200 border-solid flex flex-col gap-3"}>
            <CloseOutlined
