...
export const SubjectCard = observer((props: SubjectCardProps) => {
    const {
        id,
        index,
        name,
            ...
            <div
                ...
                </div>
                {
                    ...
                    <AcademicHoursPanel
                        ...
                        onChange={(activityId, value) => componentsStore.updateAtom(id, "academicHours", {
                            id: activityId,
                            value
                        })}
                        onAdd={(activityId) => componentsStore.updateAtom(id, "academicHours", {
                            id: activityId,
                            value: undefined
                        })}
                        onRemove={(activityId) => componentsStore.updateAtom(id, "academicHours", {
                            id: activityId,
                            value: -1
                        })}
                    />
