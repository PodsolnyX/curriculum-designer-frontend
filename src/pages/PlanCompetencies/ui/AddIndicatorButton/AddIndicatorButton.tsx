...
import {getCompetencesQueryKey, useCreateIndicatorMutation} from "@/api/axios-client/CompetenceQuery.ts";
...
const AddIndicatorButton = ({competenceId, curriculumId}: AddCompetenceIndicatorButtonProps) => {
    ...
    return (
        <div className={""}>
            {
                isPending ? <div className={"p-2 px-4 flex gap-2 items-center"}>
                    ...
                    <div
                        className={"flex justify-start items-center gap-2 p-2 px-4 cursor-pointer hover:bg-stone-50 transition"}
                        onClick={() => setIsEdit(true)}>
                        <Typography className={"text-stone-600"}>Добавить индикатор</Typography>
