...
import { AtomModuleMoveService } from '@/pages/PlanView/stores/componentsStore/atomMoveService/atomMoveService.ts';
import { AtomUpdateService } from '@/pages/PlanView/stores/componentsStore/atomUpdateService/atomUpdateService.ts';
import { ModuleUpdateService } from '@/pages/PlanView/stores/componentsStore/moduleUpdateService/moduleUpdateService.ts';
...
import { ModuleMoveService } from '@/pages/PlanView/stores/componentsStore/moduleMoveService/moduleMoveService.ts';
...
class ComponentsStore {
  ...
  get moduleUpdateService(): ModuleUpdateService {
    return new ModuleUpdateService(
      commonStore.curriculumData.id,
      this.atoms,
      this.modules,
      this.semesters,
