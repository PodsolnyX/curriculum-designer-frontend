...
import {concatIds, getIdFromPrefix, setPrefixToId} from "@/pages/PlanView/lib/helpers/prefixIdHelpers.ts";
...
import {useCurriculumData} from "@/pages/PlanView/lib/hooks/useCurriculumData.ts";
                            ...
                            >
                                {
                                    ...
                                    componentsStore.modules
                                        ...
                                        .map((module) => <ModuleLayout {...module} key={module.id}/>)
                                }
                            </div>
                            <Overlay/>
                        </TransformComponent>
