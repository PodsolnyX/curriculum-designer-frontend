...
import { cutSemesterIdFromId, getIdFromPrefix, setPrefixToId } from "@/pages/PlanView/lib/helpers/prefixIdHelpers.ts";
...
import { getModuleRootStyles } from "@/pages/PlanView/ui/widgets/ModuleLayout/ModuleLayout.tsx";
import { RefModuleSemesterDto, SelectionDto } from "@/api/axios-client.types.ts";
