...
import DepartmentsSelector from '@/pages/PlanView/ui/features/DepartmentsSelector/DepartmentsSelector.tsx';
...
const AtomContent = observer(() => {
      ...
      setSelectedSemesterNumber(
        atomInfo.semesters.findIndex(
          (semester) =>
            ...
            Number(getSemesterIdFromPrefix(selectedAtom)),
        ) + 1 || 1,
      );
  ...
  return (
    <div className={'flex flex-col gap-3'}>
      ...
      <div
        className={
          'flex-col flex gap-1 border-b border-stone-300 border-solid pb-3'
        }
      >
      ...
      <div className={'flex-col flex gap-1'}>
        ...
        <CreditsSelector
          ...
          type={'input'}
          onChange={(value) =>
            componentsStore.updateAtom(targetSubjectSemesterId, 'credit', value)
          }
        />
      </div>
      <div className={'flex-col flex gap-1'}>
