...
import {
  ...
  useGetAcademicActivityFormulaParamsQuery,
  useUpdateAcademicActivityMutation,
...
export const EditActivityModal = (props: EditActivityModalProps) => {
  ...
  const { mutateAsync: editActivity, isPending: loading } =
    useUpdateAcademicActivityMutation(initialData?.id || 0, id || '');
