  ...
  return (
    <div className={'flex h-screen'}>
      <div className={'flex-col flex bg-[#1f2c37]'}>
        <Link
          to={getRouteMain()}
          className={'bg-[#74a4a8] h-[90px] p-6 flex flex-col justify-center'}
        >
      ...
      <div className={'flex-1 bg-white overflow-y-auto'}>
        <div
          className={
            'w-full p-5 border-b-stone-100 border-b border-solid h-[90px] flex items-center justify-between gap-2'
          }
        >
