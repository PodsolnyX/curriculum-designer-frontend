...
const PageLoader = ({loading, title}: PageLoaderProps) => {
    ...
    return (
        <div className={"fixed z-50 left-0 top-0 w-screen h-screen bg-white/[.9] flex flex-col items-center justify-center"}>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' width={100} height={100}>
                <circle fill='#74a4a8' stroke='#74a4a8' strokeWidth='15' r='15' cx='40' cy='100'>
                ...
                <circle fill='#74a4a8' stroke='#74a4a8' strokeWidth='15' r='15' cx='100' cy='100'>
                ...
                <circle fill='#74a4a8' stroke='#74a4a8' strokeWidth='15' r='15' cx='160' cy='100'>
            ...
            <Typography.Text className={"text-center text-2xl"}>{title}</Typography.Text>
        </div>
    )
}
