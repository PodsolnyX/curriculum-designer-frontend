...
import {AtomType, CompetenceType, CurriculumStatusType} from "@/api/axios-client.ts";
...
export const CurriculumStatusTypeName: Record<CurriculumStatusType, {name: string}> = {
    ...
    [CurriculumStatusType.ActualWithoutRecruitment] : {name : "Актуален без набора"},
